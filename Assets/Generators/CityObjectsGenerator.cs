...
public class CityObjectsGenerator : HMM
{
    ...
    void Start()
    {
        ...
        this.ParameterInference(new List<int> {
            0, 7,9,7,1, 2, 4,8,0,2,3, 1, 2,7,9,7, 0, 1, 3, 2, 7,6,7, 1,2, 0, 2, 7, 5, 6, 7, 3,7,9,7, 2, 3, 4,8, 3, 7,6,7, 1,3,
            2, 7, 6, 7, 4, 3,0, 7,6,7, 1, 0, 2, 7,5,7, 4, 2, 7, 5, 7, 4, 3, 2, 1, 7,6,7,1, 2, 3, 4, 7, 5, 7
        ...
        //this.SaveEmissionProbabilities("/Resources/CityPropsEmission.txt");
        //this.SaveTransitionProbabilities("/Resources/CityPropsTransition.txt");
    }
}
