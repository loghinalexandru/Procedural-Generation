...
public class CityObjectsGenerator : HMM
{
    ...
    void Start()
    {
        ...
        this.ParameterInference(new List<int> {
            0, 1,7, 2, 4, 7, 5, 7, 1, 2, 0, 3, 2, 7,5,7, 1, 0, 2, 7, 5, 6, 7, 3, 2, 1,7, 3, 4, 7,5,6,7, 1, 3,
            ...
            1,2,3,4,0,1,2,3,4,7,5,7,4,3,2,4,2,3,1,0,7,5,7,0,1,2,3,4,4,3,2,1,0,1,7,5,6,7,3,2,4,1,0,2,3,1,0,2,3,7,5,7,
        });
