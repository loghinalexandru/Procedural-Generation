...
//TODO: Implementeaza functia de Log verosimilitate , ai grija la convergenta valorile sunt setate random
public class EM
{
    ...
    public float[,] GetEmissionMatrix()
    {
    ...
    public void SetNullNodes()
    {
        for (int i = 0; i < 3; ++i)
        {
            for (int j = 0; j < 3; ++j)
            {
                this.emissionMatrix[i, j] = 0;
            }
        }
    }
